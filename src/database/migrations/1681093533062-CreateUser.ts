...
export class CreateUser1681093533062 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ce4e46ef6eff784ab704dcffe7" ON "users" ("password") WHERE deleted IS NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_661c2557c3d9c885aa72cdcb74" ON "users" ("username") WHERE deleted IS NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_661c2557c3d9c885aa72cdcb74"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ce4e46ef6eff784ab704dcffe7"`);
